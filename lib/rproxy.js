...
/**
 * Start up rproxy server on the specified port
 ...
 */
function rproxy(port, options) {
    var nm;

    if (typeof options.timeout === 'number') {
        utils.reqTimeout = options.timeout || DEFAULT_TIMEOUT;
        utils.resTimeout = options.timeout || DEFAULT_TIMEOUT;
    }
    ...
    nm = require('./middlewares'); //rproxy middles
    ...
    log.info('RProxy started on ' + port + '!');
